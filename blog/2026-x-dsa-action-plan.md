...
excerpt: Executive summary On 16 July 2026, the European Commission announced that
  ...
  access to data under the Digital Services Act. The plan follows a Commission decision
  finding X in breach of the DSA and imposing a fine in December 2025. X committed
  to improve its … Read more
language: English
slug: 2026-x-dsa-action-plan
status: published
tags:
- European Commission
...
title: 'Accepted but Not Fully Adequate: What Does Compliance Mean in the X Action
  Plan?'
wordpress_post_id: 136
---
...
The Commission’s announcement describes a staged process:
  ...
  1. a breach decision;
  2. proposed corrective measures;
  3. consultation with the Board;
  4. acceptance of the action plan;
  5. a six-month implementation period;
  6. an external audit;
  7. Commission monitoring and possible further action.
