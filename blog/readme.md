...
- Digital Rights
excerpt: Civic Forensics Analyses This directory contains evidence-based analyses
  of public decisions, institutional conduct, official claims, administrative performance
  and public-interest risks. The primary focus is the European Union, its institutions,
  Member States and accession countries. Selected cases from other parts of the world
  are included where they reveal internationally relevant patterns of public administration,
  transparency, accountability, … Read more
language: English
slug: readme
status: published
tags:
...
Analyses should identify the methodology and version used. Unless a specific reason is stated, new work should follow:
  ...
  * _Standard for the Analysis of Public Decisions and Institutional Conduct_ , version 3.2, EU-adapted edition;
  * _Method of Disciplined Administrative Pressure_ , version 3.2, EU-adapted edition;
